...
HD_PWD='D:/FPGA/miniRV_pipeline/miniRV_pipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sim.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sim.tcl -notrace
