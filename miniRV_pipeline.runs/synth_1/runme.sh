...
HD_PWD='D:/FPGA/miniRV_pipeline/miniRV_pipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sim.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sim.tcl
