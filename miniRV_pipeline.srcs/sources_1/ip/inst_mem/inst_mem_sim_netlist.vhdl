...
--               D:/FPGA/miniRV_pipeline/miniRV_pipeline.srcs/sources_1/ip/inst_mem/inst_mem_sim_netlist.vhdl
-- Design      : inst_mem
...
\synth_options.dist_mem_inst\: entity work.inst_mem_dist_mem_gen_v8_0_12_synth
     port map (
      ...
      spo(24) => \^spo\(28),
      spo(23 downto 1) => \^spo\(26 downto 4),
      spo(0) => \^spo\(1)
    );
end STRUCTURE;
library IEEE;
